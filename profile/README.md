...
The LUMINA-30 ecosystem is organized into several reference layers.
...
Pre-Irreversibility Civilizational Review Criteria  
Evaluation conditions for recursively self-reconstructing AI systems.

### Incident Review Framework

Post-incident analytical structure designed to evaluate AI system failures and governance breakdowns.

### Civilization Map

A structural overview of governance layers for recursive AI systems.

---

## Repositories

The LUMINA-30 organization contains multiple repositories corresponding to these structural components.

Each repository provides specific reference materials, documents, and frameworks.
